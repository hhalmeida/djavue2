...
https://docs.djangoproject.com/en/3/topics/settings/

For the full list of settings and their values, see
https://docs.djangoproject.com/en/3/ref/settings/
"""
...
# Database
# https://docs.djangoproject.com/en/3/ref/settings/#databases
...
# Password validation
# https://docs.djangoproject.com/en/3/ref/settings/#auth-password-validators
...
# https://docs.djangoproject.com/en/3/topics/i18n/
...
# https://docs.djangoproject.com/en/3/howto/static-files/
